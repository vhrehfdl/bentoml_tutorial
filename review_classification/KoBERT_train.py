...
from KoBERT_service import ReviewClassifier
...
if __name__ == "__main__":
    ...
    with mlflow.start_run() as run:
        ...
        mlflow.log_param("class num", len(label_enc.classes_))
        ...
        mlflow.log_param("dr_rate", dr_rate)
        ...
        review_classifier.pack('max_len', max_len)
